...
public class BTreeImpl<Key extends Comparable<Key>, Value> implements BTree<Key, Value> {
	...
	private class Node
	{
		...
		private Node next; //Dont need
		private Node previous; //Dont need
		...
		private Entry[] getEntries() { return Arrays.copyOf(this.entries, this.entryCount); }
	...
	public Value put(Key k, Value v) {
		...
		{
			Object returnVal = alreadyThere.val;
			alreadyThere.val = v;
