...
public class DocumentStoreStage5Test {
	...
	/////Stage 5////////
	@Test
	public void fixTest1() throws URISyntaxException {
		DocumentStoreImpl store = new DocumentStoreImpl(null);
		store.setMaxDocumentCount(1);
		store.putDocument(input1 , uri1 , DocumentStore.DocumentFormat.TXT);
		store.putDocument(input2 , uri2 , DocumentStore.DocumentFormat.TXT);
		String a = "doc1";
		store.putDocument(new ByteArrayInputStream(a.getBytes()) , uri1 , DocumentStore.DocumentFormat.TXT);
		assertTrue(!expectedFile(uri1).exists());
		assertTrue(expectedFile(uri2).exists());
		assertEquals(null , store.getDocument(uri2));
	...
	@Test
	public void fixTest2() throws URISyntaxException {
		DocumentStoreImpl store = new DocumentStoreImpl(null);
		store.setMaxDocumentCount(1);
		store.putDocument(input1 , uri1 , DocumentStore.DocumentFormat.TXT);
		store.putDocument(input2 , uri2 , DocumentStore.DocumentFormat.TXT);
	...
	@Test
	public void fixTest3() throws URISyntaxException {
		DocumentStoreImpl store = new DocumentStoreImpl(null);
		store.setMaxDocumentCount(1);
		store.putDocument(input1 , uri1 , DocumentStore.DocumentFormat.TXT);
		store.putDocument(input2 , uri2 , DocumentStore.DocumentFormat.TXT);
	...
	@Test
	public void deleteOnDisk() throws URISyntaxException {
		DocumentStoreImpl store = new DocumentStoreImpl(null);
		store.setMaxDocumentCount(1);
		store.putDocument(input1 , uri1 , DocumentStore.DocumentFormat.TXT);
		store.putDocument(input2 , uri2 , DocumentStore.DocumentFormat.TXT);
